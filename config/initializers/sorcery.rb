...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.key = "158737930884742" 
  config.facebook.secret = "6dd9c28e28eddda4371914061d236a3e"
  config.facebook.callback_url = "http://#{DOMAIN}/oauth/callback?provider=facebook"
  ...
  config.user_config do |user|
    ...
    user.activity_timeout = 30 * 60                                                 # how long since last activity is
